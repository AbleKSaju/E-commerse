...
const salesWeekly = async (req, res) => {
  ...
  const daysUntilMonday = (currentDayOfWeek === 0 ? 6 : currentDayOfWeek - 1); // 0 is Sunday, so we subtract 1 to get to Monday
  ...
  endOfWeek.setDate(currentDate.getDate() + (6 - daysUntilMonday));
